...
@section('content')
    ...
    <div class="  mb-5 contenedor-form row justify-content-center mt-4">
        <div class=" formulario mb-5">
            ...
            <form id="formulario" class="" method="POST" action="{{ url('productos/crear') }}" enctype="multipart/form-data"
                novalidate>
                @csrf
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="id_categoria"
                        class="form-control form-control-lg @error('id_categoria') is-invalid @enderror" id="id_categoria"
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="id_catalogo"
                        class="form-control form-control-lg @error('id_catalogo') is-invalid @enderror" id="id_catalogo">
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="id_bodega" class="form-control form-control-lg @error('id_bodega') is-invalid @enderror"
                        id="id_bodega">
                ...
                <div class="form-group mt-3">
                    ...
                    <input onkeypress="return validecimal(event);" v-validate="'digits:3'" name="precio_c" step="1.00"
                        value="{{ old('precio_c') }}" class="@error('precio_c') is-invalid @enderror">
                    @error('precio_c')
                        <span class="invalid-feedback d-block" role="alert">
                ...
                <div class="form-group mt-3">
                    ...
                    <input onkeypress="return validecimal(event);" name="precio_v" step="1.00"
                        value="{{ old('precio_v') }}" class="@error('precio_v') is-invalid @enderror">
                    @error('precio_v')
                        <span class="invalid-feedback d-block" role="alert">
                            <p class="errores">{{ 'Se necesita un número' }}</p>
                        </span>
