...
@section('botones')
    ...
    <div class="regresar">
        <a href="{{ url('/Catalogo') }}" class=" volver"> <img class="imagen" src="/imagenes/regresar.png" /></a>
...
@section('content')
    <div class="contenedor-form">
        ...
        <div class="formulario">
            ...
            <form id="formulario" class="" action="{{ url('Guardar-catalogo') }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class=" mt-2 form-control @error('nombre') is-invalid @enderror"
                        id="nombre" placeholder="Nombre Producto..." value={{ old('nombre') }}>
                    @error('nombre')
