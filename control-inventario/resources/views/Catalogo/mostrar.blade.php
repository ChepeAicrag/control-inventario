...
<body>
    ...
    @section('botones')
        ...
        <a href="{{ url('/Crear-catalogo') }}" class=" boton-a mt-4 volver"> <img class="imagen" src="/imagenes/add.png" /> <p class="mt-2 mb-0">Agregar</p></a>
    @endsection
    ...
    @section('content')
        ...
        <div class="col-md-10  mx-auto p-3">
            <h2 class="text-center  mb-3">Catálogos</h2>
            <table class="table">
            ...
            <div class="mb-5">
                ...
                <p class="mt-2">Mostrando {{ $ver->firstItem() }} a {{ $ver->lastItem() }} ... de {{ $ver->total() }}
                </p>
