...
@section('content')
    <div class="contenedor-form">
        ...
        <div class="formulario">
            ...
            <form id="formulario" class="" action="{{url('Categoria-guardar')}}" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="form-group">
                    <label for="nombre">Nombre de la Categoria</label>
                    <input type="text" name="nombre" class=" mt-2 form-control @error ('nombre') is-invalid @enderror" id="nombre" placeholder="Nombre Categoria..." 
                            value={{old('nombre')}}
                    >
                    @error('nombre')
